...
export default function PprMfgCta() {
  return (
    <section className="mx-auto max-w-6xl px-5 pb-20">
      ...
      >
        <div className="flex flex-col gap-2">
          <h2
            className="text-[26px] font-semibold lg:text-[34px]"
            style={{ fontFamily: "var(--font-display)", color: "var(--platinum)" }}
          >
            See the documentation behind a lot
          </h2>
          <p className="max-w-md text-[15px] leading-relaxed" style={{ fontFamily: "var(--font-body)", color: "var(--silver-1)" }}>
            Review the latest certificates of analysis, or reach out for wholesale and bulk-lot inquiries.
          </p>
        </div>
